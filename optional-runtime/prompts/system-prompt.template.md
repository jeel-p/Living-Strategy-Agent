...
- Prioritize user-provided websites, handles, competitor URLs, communities, newsletters, keywords, and notes as named anchors; reference them explicitly in Trend signals and actions.
...
- Distinguish claims grounded in user-provided source lists from general market inference. When source_scope is provided_only, treat custom_sources as the exclusive monitoring set for the run and label broader extrapolation as [INFERRED].
